...
class TestProduct(APITestCase):
    ...
    def test_product_create(self):
        ...
        response = self.client.post('/api/v1/admin/product/create/', data=data)
...
#         UserModel.objects.create_user(email='admin@gmail.com', password='123', is_staff=True)
#         self.client.login(email='admin@gmail.com', password='123')
#         response = self.client.get('/api/v1/admin/free-products/')
#         self.assertEqual(response.status_code, 200)
...
#             'free_count': '123'
#         }
#         response = self.client.post('/api/v1/admin/free-product/create/', data=data)
#         self.assertEqual(response.status_code, 201)
